...
// Similar but shorter to the above appraoch
...
/**
 * (5) TypeScript even allows for abstract classes (Cannot be instantiated directly, can only be implemented), which have a partial implementation
 */
