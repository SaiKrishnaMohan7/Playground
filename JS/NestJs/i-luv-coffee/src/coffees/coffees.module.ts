...
@Module({
  imports: [
    ...
    ConfigModule.forFeature(coffeesConfig), // Register the configuration object specific to this module
  ], // Other modules this module imports also importing the providers those modules export
