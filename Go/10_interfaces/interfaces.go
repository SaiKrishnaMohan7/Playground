...
// Understand Emtpy interfaces better interface {}
// We don't know what is going to be a part of this interface yet
// The members of this interface maybe set sometime later in the code
...
// Describer interface (name should encapsulate what the interface is used for)
type Describer interface {
	describe() string // return type of the describe method
}

// We can use this fucntion to call the method for us, keeping it DRY
func doDescribing(describe Describer) string {
...
func main() {
	...
	userDescription := doDescribing(&u1)
	groupDescription := doDescribing(&g)
